...
var MAX_HISTORY = 40;
var MAX_INACTIVE_TIME = 1000*60*60*2; // 2 hours
var MAX_ZERO_TIME = 1000 * 10;
...
{
	if ( (this.stats.block.number == 0 && (_.now() - this.uptime.lastUpdate) > MAX_ZERO_TIME) || (this.uptime.lastStatus === false && this.uptime.lastUpdate !== null && (_.now() - this.uptime.lastUpdate) > MAX_INACTIVE_TIME ))
	{
		return true;
	}
